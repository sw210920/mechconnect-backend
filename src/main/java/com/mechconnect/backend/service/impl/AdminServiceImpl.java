...
// TO fetch all customers at admin Dashboard   
    @Override
...
//    TO fetch all mechanics at admin Dashboard   
    @Override
...
//    TO fetch all Orders at admin Dashboard   
    @Override
...
//            Pending Requests (ServiceRequest Table)
        ...
        for (ServiceRequest req : pendingRequests) {
            ...
            result.add(dto);
				        	...
				        	// Orders Table (Accepted / Completed / Rejected)
...
//    fetch dashboard status for admin
    @Override
